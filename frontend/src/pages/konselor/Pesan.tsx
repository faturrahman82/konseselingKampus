...
export default function KonselorPesan() {
  ...
  return (
    <DashboardLayout role="counselor">
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Komunikasi langsung dengan mahasiswa Anda.</p>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border overflow-hidden flex h-[calc(100vh-220px)]">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground shrink-0 ml-1">{formatTime(c.lastMessageAt)}</span>
                    </div>
        ...
        {selectedContact ? (
          ...
          <div className="hidden md:flex flex-1 flex-col items-center justify-center gap-3 text-muted-foreground">
            ...
            <p className="text-sm">Pilih kontak untuk memulai percakapan.</p>
          </div>
        )}
      </div>
    </DashboardLayout>
